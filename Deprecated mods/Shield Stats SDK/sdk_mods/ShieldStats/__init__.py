...
from .compare import BankPrepCompare, BankStartCompare, BankStopCompare, BankChangeSelectedItemKey, BankChangeSelectedItemMouse, VendorPrepCompare, VendorStartCompare, VendorChangeSelectedItemKey, VendorChangeSelectedItemMouse, InvPrepCompare, InvStartCompare, InvChangeSelectedItemKey, InvChangeSelectedItemMouse, PickupcardCompare
...
build_mod(
    ...
    keybinds=[],
    hooks=[on_startgame, BankPrepCompare, BankStartCompare, BankStopCompare, BankChangeSelectedItemKey, BankChangeSelectedItemMouse, VendorPrepCompare, VendorStartCompare, VendorChangeSelectedItemKey, VendorChangeSelectedItemMouse, InvPrepCompare, InvStartCompare, InvChangeSelectedItemKey, InvChangeSelectedItemMouse, PickupcardCompare],
    commands=[],
