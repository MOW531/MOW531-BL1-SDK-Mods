...
def patch():
    ...
    # UI
        ...
        # KeepAlive
    obj("GFxMovieDefinition","inworld_ui_MOD.weapon_card.weapon_card_DEF").ObjectFlags |= 0x4000
    obj("VendingMachineGFxDefinition","menus_vending.Definitions.VendingMachineDefinition").ObjectFlags |= 0x4000
    obj("VendingMachineGFxMovie","menus_vending_MOD.FlashInstances.vending_machine_1").ObjectFlags |= 0x4000
    ...
    obj("GFxMovieInfo","menus_mission_MOD.FlashMovies.mission_interface").ObjectFlags |= 0x4000
    obj("BankGFxMovie","menus_bank.FlashInstances.bank_instance").ObjectFlags |= 0x4000


    obj("GlobalsDefinition","gd_globals.General.Globals").ItemPickupCardMovie = obj("GFxMovieDefinition","inworld_ui_MOD.weapon_card.weapon_card_DEF")
